<div class="row">
    ...
    <div class="col-xl-4 col-md-6 col-12 mb-1">
        <fieldset class="form-group">
            ...
            <input type="text" value="{{ old('numero_empleado_id', isset($medico) ? $medico->numero_empleado_id : '') }}" class="form-control @error('numero_empleado_id') is-invalid @enderror" name="numero_empleado_id"  placeholder="Número de empleado">
