...
<div class="col-4 mb-1">
    <fieldset class="form-group">
        ...
        <input type="text" id="cantidad" value="{{ old('cantidad', isset($datos) ? $datos->cantidad : '') }}" class="form-control @error('horario') is-invalid @enderror" name="horario"  placeholder="horario">
        @error('cantidad')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
  ...
  <div class="col-xl-6 col-md-12 col-12">
    <fieldset class="form-group">
        ...
        <textarea class="form-control @error('lugar_trabajo') is-invalid @enderror" id="lugar_trabajo" name="lugar_trabajo"  placeholder="lugar de trabajo">{{ isset($datos) ? $datos->lugar_trabajo : '' }}</textarea>
        @error('lugar_trabajo')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
