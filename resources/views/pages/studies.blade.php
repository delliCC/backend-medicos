            ...
            <form class="form">
              <div class="row">
                <div class="col-md-6 col-12">
                  <div class="mb-1">
                    <label class="form-label" for="city-column">Fecha Inicio</label>
                    <input type="text" id="city-column" class="form-control" placeholder="City" name="city-column">
                  </div>
                </div>
                <div class="col-md-6 col-12">
                  <div class="mb-1">
                    <label class="form-label" for="country-floating">Fecha Fin</label>
...
<div class="card">
  <div class="card-body">
    <div class="col-12">
      <div class="card">
        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
          @include('components/studies/table')
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel1">Crear Estudio</h4>
      ...
      <div class="modal-body">
        <form id="addNewSpecialty" class="row gy-1 gx-2" onsubmit="return false" novalidate="novalidate">
          ...
          <div class="col-12">
            ...
            <textarea class="form-control" id="descripcion" rows="3" placeholder="Textarea"></textarea>
          </div>
        </form>
      </div>
